...
__help__ = """
ᱵ /runs*:* reply a random string from an array of replies
ᱵ /slap*:* slap a user, or get slapped if not a reply
ᱵ /shrug*:* get shrug XD
ᱵ /table*:* get flip/unflip :v
ᱵ /decide*:* Randomly answers yes/no/maybe
ᱵ /toss*:* Tosses A coin
ᱵ /bluetext*:* check urself :V
ᱵ /roll*:* Roll a dice
ᱵ /rlg*:* Join ears,nose,mouth and create an emo ;-;
ᱵ /shout <keyword>*:* write anything you want to give loud shout
ᱵ /weebify <text>*:* returns a weebified text
ᱵ /sanitize*:* always use this before /pat or any contact
ᱵ /pat*:* pats a user, or get patted
ᱵ /8ball*:* predicts using 8ball method
...
- Shippering
ᱵ /couples - get couples of today

- Here is the help for the Styletext module:

ᱵ /weebify <text>: weebify your text!
ᱵ /bubble <text>: bubble your text!
ᱵ /fbubble <text>: bubble-filled your text!
ᱵ /square <text>: square your text!
ᱵ /fsquare <text>: square-filled your text!
ᱵ /blue <text>: bluify your text!
ᱵ /latin <text>: latinify your text!
ᱵ /lined <text>: lined your text!
"""
