...
ᱵ /cleanblue <on/off/yes/no>*:* clean commands after sending
ᱵ /ignoreblue <word>*:* prevent auto cleaning of the command
ᱵ /unignoreblue <word>*:* remove prevent auto cleaning of the command
ᱵ /listblue*:* list currently whitelisted commands

 *Following are Disasters only commands, admins cannot use these:*

ᱵ /gignoreblue <word>*:* globally ignorea bluetext cleaning of saved word across Saitama.
ᱵ /ungignoreblue <word>*:* remove said command from global cleaning list
"""
