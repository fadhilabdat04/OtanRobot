...
ᱵ /kickme*:* kicks the user who issued the command

*Admins only:*

ᱵ /ban <userhandle>*:* bans a user. (via handle, or reply)
ᱵ /sban <userhandle>*:* Silently ban a user. Deletes command, Replied message and doesn't reply. (via handle, or reply)
ᱵ /tban <userhandle> x(m/h/d)*:* bans a user for x time. (via handle, or reply). m = minutes, h = hours, d = days.
ᱵ /unban <userhandle>*:* unbans a user. (via handle, or reply)
ᱵ /kick <userhandle>*:* kicks a user out of the group, (via handle, or reply)
ᱵ /mute <userhandle>*:* silences a user. Can also be used as a reply, muting the replied to user.
ᱵ /tmute <userhandle> x(m/h/d)*:* mutes a user for x time. (via handle, or reply). m = minutes, h = hours, d = days.
ᱵ /unmute <userhandle>*:* unmutes a user. Can also be used as a reply, muting the replied to user.
ᱵ /zombies*:* searches deleted accounts
ᱵ /zombies clean*:* removes deleted accounts from the group.
ᱵ /snipe <chatid> <string>*:* Make me send a message to a specific chat.
"""
