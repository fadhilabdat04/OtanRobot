...
*Admin commands:*
ᱵ /approval*:* Check a user's approval status in this chat.
ᱵ /approve*:* Approve of a user. Locks, blacklists, and antiflood won't apply to them anymore.
ᱵ /unapprove*:* Unapprove of a user. They will now be subject to locks, blacklists, and antiflood again.
ᱵ /approved*:* List all approved users.
ᱵ /unapproveall*:* Unapprove *ALL* users in a chat. This cannot be undone.
"""
