...
__help__ = """
*User Commands*:
ᱵ /admins*:* list of admins in the chat
ᱵ /pinned*:* to get the current pinned message.

*The Following Commands are Admins only:* 
ᱵ /pin*:* silently pins the message replied to - add `'loud'` or `'notify'` to give notifs to users
ᱵ /unpin*:* unpins the currently pinned message
ᱵ /invitelink*:* gets invitelink
ᱵ /promote*:* promotes the user replied to
ᱵ /fullpromote*:* promotes the user replied to with full rights
ᱵ /demote*:* demotes the user replied to
ᱵ /title <title here>*:* sets a custom title for an admin that the bot promoted
ᱵ /admincache*:* force refresh the admins list
ᱵ /del*:* deletes the message you replied to
ᱵ /purge*:* deletes all messages between this and the replied to message.
ᱵ /purge <integer X>*:* deletes the replied message, and X messages following it if replied to a message.
ᱵ /setgtitle <text>*:* set group title
ᱵ /setgpic*:* reply to an image to set as group photo
ᱵ /setdesc*:* Set group description
ᱵ /setsticker*:* Set group sticker

*Rules*:
ᱵ /rules*:* get the rules for this chat.
ᱵ /setrules <your rules here>*:* set the rules for this chat.
ᱵ /clearrules*:* clear the rules for this chat.
"""
