...
ᱵ /connect: Connects to chat (Can be done in a group by /connect or /connect <chat id> in PM)
ᱵ /connection: List connected chats
ᱵ /disconnect: Disconnect from a chat
ᱵ /helpconnect: List available commands that can be used remotely

*Admin only:*

ᱵ /allowconnect <yes/no>: allow a user to connect to a chat
"""
