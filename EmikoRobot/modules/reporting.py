...
__help__ = """
ᱵ /report <reason>*:* reply to a message to report it to admins.
ᱵ @admin*:* reply to a message to report it to admins.
*NOTE:* Neither of these will get triggered if used by admins.

*Admins only:*
ᱵ /reports <on/off>*:* change report setting, or view current status.
ᱵ If done in pm, toggles your status.
ᱵ If in group, toggles that groups's status.
"""
