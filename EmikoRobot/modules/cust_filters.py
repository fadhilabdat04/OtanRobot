...
__help__ = """
ᱵ /filters*:* List all active filters saved in the chat.
*Admin only:*
ᱵ /filter <keyword> <reply message>*:* Add a filter to this chat. The bot will now reply that message whenever 'keyword'\
...
ᱵ /stop <filter keyword>*:* Stop that filter.

*Chat creator only:*

ᱵ /removeallfilters*:* Remove all chat filters at once.
