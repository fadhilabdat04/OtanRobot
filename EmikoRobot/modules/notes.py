...
__help__ = """
ᱵ /get <notename>*:* get the note with this notename
ᱵ #<notename>*:* same as /get
ᱵ /notes or /saved*:* list all saved notes in this chat
ᱵ /number *:* Will pull the note of that number in the list
If you would like to retrieve the contents of a note without any formatting, use `/get <notename> noformat`. This can \
be useful when updating a current note

*Admins only:*
ᱵ /save <notename> <notedata>*:* saves notedata as a note with name notename
A button can be added to a note by using standard markdown link syntax - the link should just be prepended with a \
`buttonurl:` section, as such: `[somelink](buttonurl:example.com)`. Check `/markdownhelp` for more info
ᱵ /save <notename>*:* save the replied message as a note with name notename
 ...
 *Example:*
 ...
 %%%
 Reply 3`
ᱵ /clear <notename>*:* clear note with this name
ᱵ /removeallnotes*:* removes all notes from the group
